"""
LinkedIn Session Login Helper
Opens LinkedIn and waits for you to login, then saves the session.
...
def main():
    print("=" * 60)
    print("LINKEDIN SESSION LOGIN HELPER")
    print("=" * 60)
    print()
    print("This will open LinkedIn and wait for you to login.")
    ...
    try:
        with sync_playwright() as p:
            ...
            print("=" * 60)
            print("[OK] Enter your email/phone and password")
            print("[OK] Complete any verification")
            print("[OK] Wait until you see your LinkedIn feed")
            ...
            while wait_time < max_wait:
                ...
                # Check if logged in by looking for "Start a post" button
                try:
                    # Method 1: Check for "Start a post" button
                    post_btn = page.locator('button:has-text("Start a post")').first
                    if post_btn.count() > 0:
                        logged_in = True
                        break
                    
                    # Method 2: Check URL (should be feed, not login)
                    if "linkedin.com/feed" in page.url and "login" not in page.url.lower():
                        logged_in = True
                        break
            ...
            if logged_in:
                ...
                # Take screenshot
                screenshot_path = Path(__file__).parent / "screenshots" / "linkedin_login_success.png"
                ...
                print("  - python playwright_linkedin_post.py --caption 'Your caption'")
                print("  - Dashboard LinkedIn form at http://localhost:3000")
                print()
                ...
                print()
                print("=" * 60)
                print("[WARNING] Login not detected within 5 minutes")
                print("=" * 60)
                print()
                print("Session NOT saved. Please try again.")
                print("Make sure to:")
                print("  1. Enter correct email/password")
